      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="absolute bottom-4 right-4 sm:-bottom-8 sm:-right-8 bg-primary text-white p-6 sm:p-7 rounded-[1px] shadow-2xl max-w-xs border border-white/10">
              <div className="flex items-center gap-3 mb-2">
                <div className="p-3 aspect-square rounded-full bg-accent flex items-center justify-center font-extrabold text-dark text-lg shrink-0">
                  24/7
                </div>
                <div>
          ...
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-dark mb-5 tracking-tight leading-[1.1]">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <a 
                href="tel:0597684860" 
                className="bg-accent hover:bg-accent/90 text-dark px-7 py-3.5 font-bold transition-all duration-200 shadow-md shadow-accent/25 hover:-translate-y-0.5 rounded-full"
              >
    ...
    <section className="py-12 md:py-16 lg:py-20 bg-slate-50/70 relative border-y border-gray-200/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 text-center">
          <Link 
            to="/services" 
            className="bg-accent hover:bg-accent/90 text-dark px-4 sm:px-8 md:px-10 py-4 font-bold transition-all shadow-md shadow-accent/25 hover:shadow-accent/40 hover:-translate-y-0.5 inline-flex items-center gap-2 rounded-full"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            {/* Decorative Element */}
            <div className="absolute -bottom-6 -left-6 bg-accent text-dark p-6 rounded-[1px] shadow-xl border border-white/20 hidden sm:block">
