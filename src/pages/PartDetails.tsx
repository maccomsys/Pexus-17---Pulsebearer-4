          ...
          <div className="w-full lg:w-2/3">
            ...
            <div className="bg-primary rounded-[1px] p-6 sm:p-8 md:p-12 text-white mb-12 relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                ...
                <button className="w-full md:w-auto bg-accent hover:bg-accent/90 text-dark font-bold px-4 sm:px-8 py-4 transition-all whitespace-nowrap shadow-lg rounded-full">
          ...
          <div className="w-full lg:w-1/3">
            <div className="bg-white rounded-[1px] p-6 sm:p-8 border border-dark/10 shadow-xl lg:sticky lg:top-32">
              ...
              <div className="space-y-3 mb-6">
                <button className="w-full bg-accent hover:bg-accent/90 text-dark font-bold py-4 transition-all shadow-md flex items-center justify-center gap-2 rounded-full">
