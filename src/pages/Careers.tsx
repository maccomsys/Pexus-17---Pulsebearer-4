          ...
          <div className="max-w-2xl">
            ...
            >
              <button 
                ...
                className="bg-accent hover:bg-accent/90 text-dark px-4 sm:px-8 py-4 font-bold transition-all shadow-lg shadow-accent/20 rounded-full"
              >
                View Open Positions
              </button>
              <a 
                            ...
                            <div className="bg-white p-6 rounded-[1px] border border-dark/20 shadow-sm sticky top-32">
                              ...
                              {!isApplyingFor || isApplyingFor !== job.id ? (
                                <button 
                                  ...
                                  className="w-full bg-accent hover:bg-accent/90 text-dark px-6 py-4 font-bold transition-all shadow-lg flex justify-center items-center gap-2 text-lg rounded-full"
                                >
                          ...
                          {applicationSuccess ? (
                            ...
                            <form onSubmit={handleApply} className="space-y-6">
                              ...
                              <button 
                                ...
                                className="bg-accent hover:bg-accent/90 text-dark font-bold px-4 sm:px-8 py-4 transition-all shadow-lg flex items-center justify-center gap-2 w-full md:w-auto disabled:opacity-50 rounded-full"
                              >
      ...
      <section className="py-12 md:py-20 bg-primary text-white text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button 
              onClick={scrollToJobs}
              className="bg-accent hover:bg-accent/90 text-dark px-4 sm:px-8 py-4 font-bold transition-all shadow-xl text-lg rounded-full"
            >
              View Open Positions
            </button>
