      ...
      <section className="relative bg-primary text-white py-16 md:py-24 lg:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          ...
          <div className="max-w-3xl">
            ...
            >
              <button className="bg-accent hover:bg-accent/90 text-dark px-4 sm:px-8 py-4 font-bold transition-all shadow-lg shadow-accent/20 rounded-full">
            ...
            <div className="grid lg:grid-cols-5 gap-8 lg:gap-4 relative z-10">
              {STEPS.map((step, idx) => (
                <div key={idx} className="bg-white p-6 rounded-[1px] border border-dark/10 shadow-xl shadow-charcoal/5 relative">
                  <div className="w-12 h-12 bg-accent text-dark font-bold rounded-xl flex items-center justify-center mb-6 shadow-lg shadow-charcoal/20">
                    {step.step}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="w-full sm:w-1/3 flex justify-start">
              <Link to="/parts" className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-[1px] transition-colors max-w-full">
