        ...
        {lightboxIndex !== null && (
          ...
          >
            ...
            <button 
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 text-white/70 hover:text-dark transition-colors bg-white/10 hover:bg-accent rounded-xl p-3 rounded-full"
            >
            ...
            <button 
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 text-white/70 hover:text-dark transition-colors bg-white/10 hover:bg-accent rounded-xl p-3 rounded-full"
            >
            ...
            {VIDEOS.map((video) => (
              <div key={video.id} className="group relative rounded-[1px] overflow-hidden aspect-video bg-white cursor-pointer shadow-sm hover:shadow-xl transition-all border border-dark/10">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-16 h-16 bg-white/90 backdrop-blur-sm text-primary rounded-xl flex items-center justify-center shadow-lg group-hover:bg-accent group-hover:text-dark transition-all duration-300 group-hover:scale-110">
