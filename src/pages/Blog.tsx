      ...
      <section className="relative bg-primary overflow-hidden pt-16 pb-24 md:pt-24 md:pb-32">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            />
            <button type="submit" className="bg-accent hover:bg-accent/90 text-dark px-6 py-3 font-bold transition-all rounded-full">
              Search
            </button>
          </motion.form>
        </div>
              ...
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/2 relative overflow-hidden">
                  ...
                  <div className="absolute top-6 left-6 z-20">
                    <span className="bg-accent text-dark text-xs font-bold px-3 py-1.5 uppercase tracking-wider shadow-lg rounded-full">
            ...
            <div className="bg-primary rounded-[1px] p-6 sm:p-8 text-white relative overflow-hidden shadow-xl">
              ...
              <form className="space-y-3" onSubmit={e => { e.preventDefault(); (e.target as HTMLFormElement).reset(); alert('Subscribed successfully!'); }}>
                <input 
                  ...
                  required
                />
                <button type="submit" className="w-full bg-accent hover:bg-accent/90 text-dark font-bold py-3 transition-colors text-sm shadow-md rounded-full">
                  Subscribe Now
                </button>
              </form>
            </div>
              ...
              <div className="flex flex-wrap gap-2">
                {TAGS.map((tag, idx) => (
                  <button 
                    ...
                    className="bg-slate-100 hover:bg-accent hover:text-dark text-dark/70 text-xs font-bold px-3 py-1.5 transition-colors rounded-full"
                  >
                    {tag}
                  </button>
                ))}
      ...
      <section className="py-12 md:py-20 bg-primary text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/contact" className="bg-accent hover:bg-red-700 text-dark px-4 sm:px-8 py-4 font-bold transition-all shadow-xl rounded-full">
