    ...
    <main className="pt-24 lg:pt-[104px] min-h-screen">
      ...
      <section className="relative bg-primary overflow-hidden pt-12 pb-32 md:pt-20 md:pb-40">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <a href="tel:0597684860" className="bg-accent hover:bg-accent/90 text-dark px-4 sm:px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center gap-2 rounded-full">
              ...
              return (
                ...
                >
                  <div className="w-14 h-14 bg-primary rounded-xl flex items-center justify-center mb-6 group-hover:bg-accent transition-colors">
                    <Icon className="w-7 h-7 text-white group-hover:text-dark transition-colors" />
                  </div>
                  ...
                  <div className="mt-auto pt-4 border-t border-dark/10 space-y-2">
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                      <a href="tel:0597684860" className="flex-1 bg-accent hover:bg-accent/90 text-dark text-center py-2.5 px-3 text-xs sm:text-sm font-bold transition-all shadow-sm flex items-center justify-center gap-1 min-h-[40px] rounded-full">
            ...
            {WHY_CHOOSE_US.map((feature, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white/5 border border-white/10 rounded-[1px] p-6 text-center hover:bg-accent hover:text-dark transition-all group"
                >
                  <Icon className="w-10 h-10 mx-auto text-primary group-hover:text-dark mb-4 transition-colors" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {MAINTENANCE_PACKAGES.map((pkg, idx) => (
              ...
              >
                {pkg.popular && (
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-accent text-dark px-4 py-1 rounded-md text-xs font-bold uppercase tracking-wider">
                    Most Popular
                  </div>
                )}
                ...
                <button className={cn(
                  ...
                  pkg.popular ? "bg-accent hover:bg-accent/90 text-dark" : "bg-white hover:bg-dark/5 text-dark"
                )}>
                  Get Quote
                </button>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-2xl bg-primary rounded-[1px] p-6 sm:p-8 md:p-12 shadow-2xl">
            ...
            <div className="space-y-4">
              <a href="tel:0597684860" className="w-full bg-accent hover:bg-accent/90 text-dark px-4 sm:px-8 py-4 font-bold transition-all shadow-xl text-lg flex justify-center items-center gap-2 rounded-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="w-full sm:w-1/3 flex justify-start">
              <Link to="/haulage" className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-[1px] transition-colors max-w-full">
                ...
                <div className="overflow-hidden">
                  ...
                  <div className="text-sm font-bold text-dark group-hover:text-accent truncate">Haulage & Heavy Transport</div>
                </div>
              </Link>
            </div>
            ...
            <div className="w-full sm:w-1/3 flex justify-end">
              <Link to="/body-works" className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-[1px] transition-colors max-w-full text-right">
                <div className="overflow-hidden">
                  <div className="text-xs text-dark/50 font-bold uppercase tracking-wider mb-0.5">Next Service</div>
                  <div className="text-sm font-bold text-dark group-hover:text-accent truncate">Body Works</div>
                </div>
                <div className="w-10 h-10 shrink-0 bg-slate-100 flex items-center justify-center rounded-full group-hover:bg-accent group-hover:text-white transition-colors">
