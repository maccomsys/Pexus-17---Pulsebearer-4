          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white/5 border border-white/10 rounded-[1px] p-4 sm:p-6 md:p-8">
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex gap-2">
                  <button 
                    ...
                    className="w-10 h-10 bg-white/10 hover:bg-accent text-white flex items-center justify-center transition-colors hover:text-dark"
                  >
                    &larr;
                  </button>
                  <button 
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-8 relative">
                ...
                <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-accent text-dark rounded-xl items-center justify-center z-10 shadow-xl border-4 border-dark">
                  <MoveRight className="w-5 h-5" />
                </div>
                <div className="relative rounded-[1px] overflow-hidden aspect-[4/3]">
                  <img src={beforeAfterImages[activeBeforeAfter].after} alt="After" className="w-full h-full object-cover" />
                  <div className="absolute top-4 right-4 bg-accent text-dark px-4 py-1.5 rounded-[1px] text-sm font-bold shadow-md">
                    After
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-primary rounded-[1px] p-6 sm:p-8 md:p-12 overflow-hidden relative flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div className="md:w-1/2 relative z-10">
              ...
              <button className="bg-accent hover:bg-accent/90 text-dark font-bold px-4 sm:px-8 py-4 transition-all shadow-md rounded-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="w-full sm:w-1/3 flex justify-start">
              <Link to="/repairs" className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-[1px] transition-colors max-w-full">
            ...
            <div className="w-full sm:w-1/3 flex justify-end">
              <Link to="/parts" className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-[1px] transition-colors max-w-full text-right">
                <div className="overflow-hidden">
                  <div className="text-xs text-dark/50 font-bold uppercase tracking-wider mb-0.5">Next Service</div>
                  <div className="text-sm font-bold text-dark group-hover:text-accent truncate">Auto Parts</div>
                </div>
                <div className="w-10 h-10 shrink-0 bg-slate-100 flex items-center justify-center rounded-full group-hover:bg-accent group-hover:text-white transition-colors">
