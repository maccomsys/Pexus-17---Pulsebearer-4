      ...
      <section className="relative bg-primary overflow-hidden pt-12 pb-32 md:pt-24 md:pb-40">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            />
            <button className="bg-accent hover:bg-accent/90 text-dark px-6 py-3 font-bold transition-all rounded-full">
              Search
            </button>
          </motion.div>
          ...
          >
            <button className="bg-accent hover:bg-accent/90 text-dark px-4 sm:px-8 py-4 font-bold transition-all shadow-lg shadow-accent/30 rounded-full">
              Shop All Parts
            </button>
              ...
              >
                <div className="aspect-[4/3] rounded-[1px] overflow-hidden mb-6 relative bg-white">
                  ...
                  <div className="absolute inset-0 bg-primary/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3 backdrop-blur-sm">
                    <button className="w-12 h-12 bg-white flex items-center justify-center text-dark hover:bg-accent hover:text-dark transition-colors shadow-lg rounded-full" title="Quick View">
                      <Eye className="w-5 h-5" />
                    </button>
                    <button className="w-12 h-12 bg-accent text-dark flex items-center justify-center hover:bg-accent transition-colors shadow-lg rounded-full" title="Add to Cart">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="w-full sm:w-1/3 flex justify-start">
              <Link to="/body-works" className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-[1px] transition-colors max-w-full">
            ...
            <div className="w-full sm:w-1/3 flex justify-end">
              <Link to="/fleet" className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-[1px] transition-colors max-w-full text-right">
                <div className="overflow-hidden">
                  <div className="text-xs text-dark/50 font-bold uppercase tracking-wider mb-0.5">Next Service</div>
                  <div className="text-sm font-bold text-dark group-hover:text-accent truncate">Our Fleet</div>
                </div>
                <div className="w-10 h-10 shrink-0 bg-slate-100 flex items-center justify-center rounded-full group-hover:bg-accent group-hover:text-white transition-colors">
